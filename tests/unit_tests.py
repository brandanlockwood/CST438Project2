...
class function_Test(unittest.TestCase):
    ...
    def test_command_help(self):
        ...
        self.assertEquals(response,"!! about -gives description of room !! help -gives all commands of the room !! say <something> -makes me say <something> !! chatBot <something> -say something to chatterbot !! smile -to make bot a little happier")
